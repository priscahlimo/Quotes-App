...
export class QuotesComponent implements OnInit {
  quotes:Quotes[]=[
    new Quotes("Martin Luther King Jr.", 'Priscah Limo', '"Our lives begin to end the day we become silent about things that matter And If you concentrate on what you do not have."', 120,1 ,new Date(2015,1,5)),
